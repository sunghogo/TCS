# Example rucksacks data in prompt
example_rucksacks = """vJrwpWtwJgWrhcsFMMfFFhFp
...
# Actual test rucksacks data
actual_rucksacks = """qFdBBvtHHfvRlfvsqldvqjPpQmnQmjnjjjTRTLGRNG
...
NWVqqcHHNpsNcNVdVlhCMlHQQMQQzLfzQPttFGPMLSLgtF""".split('\n')